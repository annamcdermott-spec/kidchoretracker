        ...
        <div className="mx-auto flex max-w-4xl flex-col gap-4 px-6 py-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <input
              ...
              className="h-12 w-24 rounded-xl border border-slate-300 px-4 py-2 text-lg outline-none focus:border-[#22c55e] focus:ring-2 focus:ring-[#22c55e]"
      ...
      <main className="mx-auto max-w-4xl px-6 py-8">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="flex gap-4">
              <input
                ...
                className="min-h-[48px] flex-1 rounded-xl border border-slate-300 px-4 py-3 text-lg outline-none focus:border-[#22c55e] focus:ring-2 focus:ring-[#22c55e]"
                aria-label="Kid name"
              />
              <button
                type="button"
                onClick={addKid}
                className="min-h-[48px] shrink-0 rounded-xl bg-[#22c55e] px-5 py-3 text-lg font-medium text-white hover:bg-[#16a34a] focus:outline-none focus:ring-2 focus:ring-[#22c55e] focus:ring-offset-2"
              >
                Add kid
              </button>
            </div>
            <ul className="mt-6 space-y-2" role="list">
              {kids.length === 0 ? (
                <li className="py-6 text-center text-lg text-slate-500">No kids yet.</li>
              ) : (
                kids.map((kid) => (
                  <li key={kid.id}>
                    <button
            ...
            {selectedKid && (
              <div className="mt-6 border-t border-slate-200 pt-6">
                ...
                {assignedChoreIdsForSelectedKid.length === 0 ? (
                  ...
                  <ul className="space-y-2 text-lg text-slate-700" role="list">
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
              ...
              <label className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="min-h-[48px] w-24 rounded-xl border border-slate-300 px-4 py-3 text-lg outline-none focus:border-[#22c55e] focus:ring-2 focus:ring-[#22c55e]"
            ...
            <ul className="mt-6 space-y-2" role="list">
              {chores.length === 0 ? (
                <li className="py-6 text-center text-lg text-slate-500">No chores yet.</li>
              ) : (
                chores.map((chore) => (
                  <li
                    key={chore.id}
                    className="flex min-h-[48px] items-center justify-between gap-4 rounded-lg bg-slate-50 px-4 py-3 text-lg text-slate-700 transition-colors hover:bg-slate-100"
                  >
                    ...
                    <button
                      ...
                      className="min-h-[48px] min-w-[90px] shrink-0 rounded-xl bg-[#3b82f6] px-4 py-2 text-base font-medium text-white hover:bg-[#2563eb] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-[#3b82f6] focus:outline-none focus:ring-2 focus:ring-[#3b82f6] focus:ring-offset-2"
